...
import { LayoutDashboard, Calendar, TableProperties, Plus, Settings, LogOut } from 'lucide-react'
          ...
          {showLogoutConfirm ? (
            ...
            <div className="flex items-center gap-2.5 px-2 py-2 rounded-xl hover:bg-white/5 transition-colors group">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-white/30 text-[10px] font-medium">{user?.id === 'ceo' ? 'CEO · Métricas IA' : 'Marketing · Métricas IA'}</p>
              </div>
